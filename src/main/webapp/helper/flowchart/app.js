...
// ------------------------ rendering ------------------------------------
        ...
        jsPlumb.on("#canvas", "tap", ".node-delete, .node-delete i", function () {
        ...
        jsPlumb.on("#canvas", "tap", ".node-edit, .node-edit i", function () {
...
// ------------------------ / rendering ------------------------------------
        ...
        var _updateDataset = function () {
            document.getElementById("dataset").innerHTML = _syntaxHighlight(JSON.stringify(toolkit.exportData(), null, 4));
        };
        //
